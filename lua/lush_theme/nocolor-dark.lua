...
local theme = lush( function(injected_functions)
  ...
  return { Normal         { bg = black.li(4), fg = white.da(20) }
         ...
         , Added          { LineNr, fg = DiffAdd.fg }
         , Changed        { LineNr, fg = DiffChange.fg }
         , Removed        { LineNr, fg = DiffDelete.fg }
         ...
         , CSVColumnHeaderEven      { fg = white.da(50), bold = true, italic = true }
         , CSVColumnOdd             { fg = white }
         , CSVColumnEven            { fg = white.da(50) }
         }
